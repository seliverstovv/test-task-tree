...
#### Часть 3 (done)
По клику на элемент(с зажатой клавишей shift) выделяем цветом его и путь до корневого элемента, при клике на другой элемент(с зажатой клавишей shift) выделяем цветом путь между двумя элементами.
#### Часть 4 (todo)
Покрыть код тестами.
#### Часть 5 (todo)
